...
export default function DashboardClient() {
    ...
    const handleBackToDashboard = useCallback(() => {
        ...
        const savedY = Number(sessionStorage.getItem("katakita_dashboardScrollY") || dashboardScrollY.current);
    ...
    return (
        <div className="relative antialiased overflow-x-hidden min-h-screen bg-slate-50 dark:bg-dark-bg text-slate-900 dark:text-dark-text font-poppins transition-colors duration-300">
            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                <Navbar />
                <main className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-0 transition-opacity duration-300 ${mounted ? "opacity-100" : "opacity-0"}`}>
                    {error && (
