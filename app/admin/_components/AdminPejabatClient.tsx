...
export default function AdminPejabatClient() {
 ...
 <div>
 <label className="block text-xs font-black text-slate-400 tracking-widest mb-2">Jabatan</label>
 <input
 type="text"
 value={formJabatan}
 ...
 <div>
 <label className="block text-xs font-black text-slate-400 tracking-widest mb-2">Jenis Kelamin</label>
 <select
 value={formGender}
 ...
 <div>
 <div className="text-xs font-bold tracking-wider text-slate-500">Pejabat #{index + 1}</div>
