...
export default function KelolaAdmin() {
 ...
 <th className="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">No</th>
 <th className="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Pengguna</th>
 <th className="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Role</th>
 <th className="px-6 py-4 text-left text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Terdaftar</th>
 <th className="px-6 py-4 text-center text-xs font-bold text-slate-500 dark:text-slate-400 tracking-wider">Aksi</th>
 </tr>
 </thead>
